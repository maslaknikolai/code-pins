...
2. Для каждого такого пина восстанавливаем позицию: парсим его `pinPath` (`packages/campaigns-ui/src/components/tables/ListsTable/ListPopupMenu.tsx:22:11` → файл, строка 22, колонка 11), открываем документ.
...
- пин, воткнутый прямо в общей строке, сам рисует её первым ребёнком;
