...
Расширение VS Code: визуальная карта кода — **CodePinsFile**. Ставишь курсор на symbol, жмёшь хоткей — symbol попадает в CodePinsFile как «пин». Пины одного файла живут в одном узле, между узлами рисуются стрелки «кто на кого ссылается».
...
- **Extension host** (`src/extension/`) — Node-часть. Команды, language server, хранение данных CodePinsFile, сохранение.
